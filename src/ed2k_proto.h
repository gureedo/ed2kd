...
// capabilities, values for TN_SERVER_FLAGS
enum client_caps {
        CLI_CAP_ZLIB         = 0x0001,
        CLI_CAP_IPINLOGIN    = 0x0002,
        CLI_CAP_AUXPORT      = 0x0004,
        CLI_CAP_NEWTAGS      = 0x0008,
        CLI_CAP_UNICODE      = 0x0010,
        CLI_CAP_LARGEFILES   = 0x0100,
        CLI_CAP_SUPPORTCRYPT = 0x0200,
        CLI_CAP_REQUESTCRYPT = 0x0400,
